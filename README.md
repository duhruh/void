...
<p align="center">
  ...
  <a href="https://github.com/duhruh/void/releases"><img src="https://img.shields.io/badge/release-v1.0.1-6750A4?style=flat-square" alt="Latest Release"></a>
...
### Windows
- Download `Void-1.0.1.exe` (NSIS Installer) or `Void-1.0.1-portable.exe` (Portable build).
- Run the executable to install or launch instantly.

### macOS
- Download `Void-1.0.1.dmg` or `Void-1.0.1-mac.zip`.
- Open the DMG and drag Void to your `Applications` folder.

### Linux
- Download `Void-1.0.1.AppImage` (portable AppImage) or `void-desktop_1.0.1_amd64.deb` (Debian/Ubuntu package).
- For deb: run `sudo dpkg -i void-desktop_1.0.1_amd64.deb`.
